...
const allCases = [
  ...
  { id: 'm3i-selection-fallback', serveRoot: resolve(repositoryRoot, 'dist-site'), page: 'index.html?smoke=m3i&force-fallback=true', pass: 'M3I_SITE_SMOKE_PASS', fail: 'M3I_SITE_SMOKE_FAIL', flags: ['--disable-gpu'] }
];
